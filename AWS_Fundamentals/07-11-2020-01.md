...
* All subnets created in default VPC are automatically assign IPv4 Public address. This also means, that EC2 instance (created in Default VPC) by default are accessible from Internet and vice versa.
