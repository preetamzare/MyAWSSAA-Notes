...
* Producht which focuses on operations, management and monitoring. In short critical part of Production operations
...
* This products is to generate event to specific action as specific time of the day.
